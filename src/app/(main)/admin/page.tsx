...
export default async function AdminDashboardPage() {
  ...
  return (
    <div className="space-y-10 animate-in fade-in duration-500">
      ...
      <div className="habbo-box bg-[#0a1325] border border-[#1e293b] p-6 sm:p-8 rounded-[3px] relative overflow-hidden shadow-2xl">
        ...
        <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div className="space-y-2 max-w-2xl">
            <div className="flex items-center gap-2">
              <span className="px-2.5 py-0.5 rounded-[2px] bg-[#050a14] border border-[#facc15] text-[#facc15] text-xs font-black tracking-wider uppercase flex items-center gap-1.5 shadow">
                <Sparkles className="w-3.5 h-3.5" /> YÖNETİM KOMUTA MERKEZİ v4.0
              </span>
              <span className="px-2.5 py-0.5 rounded-[2px] bg-[#050a14] border border-[#3b82f6] text-[#3b82f6] text-xs font-black tracking-wider uppercase flex items-center gap-1.5 shadow">
                <CheckCircle2 className="w-3.5 h-3.5" /> CANVA PRO SİSTEMİ AKTİF
              </span>
            </div>
            <h1 className="text-2xl sm:text-3xl font-black text-white tracking-tight uppercase">
              HABBO<span className="text-[#facc15]">ZONE</span> YÖNETİM PANELİ
            </h1>
            <p className="text-xs text-gray-300 leading-relaxed font-bold uppercase tracking-wide">
          ...
          <div className="flex flex-wrap gap-2.5 shrink-0">
            <Link 
              href="/admin/studio" 
              className="habbo-button warning px-4 py-2.5 text-xs font-black uppercase tracking-wider flex items-center gap-2"
            >
              <Wand2 className="w-4 h-4 animate-pulse" /> CANVA GÖRSEL
            </Link>
            <Link 
              href="/admin/id-studio" 
              className="habbo-button blue px-4 py-2.5 text-xs font-black uppercase tracking-wider flex items-center gap-2"
            >
              <CreditCard className="w-4 h-4" /> KART & İMZA
            </Link>
            <Link 
              href="/admin/room-studio" 
              className="habbo-button success px-4 py-2.5 text-xs font-black uppercase tracking-wider flex items-center gap-2"
            >
              <Compass className="w-4 h-4 animate-spin-slow" /> HARİTA STÜDYOSU
            </Link>
            <Link 
              href="/admin/outfit-studio" 
              className="habbo-button px-4 py-2.5 text-xs font-black uppercase tracking-wider flex items-center gap-2"
            >
              <Shirt className="w-4 h-4" /> KOMBİN STÜDYOSU
            </Link>
            <Link 
              href="/admin/giveaway-studio" 
              className="habbo-button warning px-4 py-2.5 text-xs font-black uppercase tracking-wider flex items-center gap-2"
            >
              <Trophy className="w-4 h-4" /> TURNUVA & KURA
            </Link>
            <Link 
              href="/admin/magazines" 
              className="habbo-button blue px-4 py-2.5 text-xs font-black uppercase tracking-wider flex items-center gap-2"
            >
              <Layers className="w-4 h-4" /> DERGİ STÜDYOSU
            </Link>
            <Link 
              href="/admin/news/new" 
              className="habbo-button success px-4 py-2.5 text-xs font-black uppercase tracking-wider flex items-center gap-2"
            >
              <Newspaper className="w-4 h-4" /> YENİ HABER YAZ
            </Link>
          </div>
        </div>

        {/* Canlı Durum Kartları */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-6 pt-6 border-t border-[#1e293b]">
          <div className="flex items-center gap-3 bg-[#050a14] px-3.5 py-2.5 rounded-[2px] border border-[#1e293b] shadow">
            <Cpu className="w-4 h-4 text-[#facc15] shrink-0" />
            <div>
              <div className="text-[10px] text-gray-400 font-black uppercase tracking-wider">AI MOTORU</div>
              <div className="text-xs font-black text-white uppercase tracking-tight">NVIDIA NIM (FLUX.1)</div>
            </div>
          </div>
          <div className="flex items-center gap-3 bg-[#050a14] px-3.5 py-2.5 rounded-[2px] border border-[#1e293b] shadow">
            <ShieldCheck className="w-4 h-4 text-[#3b82f6] shrink-0" />
            <div>
              <div className="text-[10px] text-gray-400 font-black uppercase tracking-wider">VERİTABANI</div>
              <div className="text-xs font-black text-white uppercase tracking-tight">SUPABASE REALTIME</div>
            </div>
          </div>
          <div className="flex items-center gap-3 bg-[#050a14] px-3.5 py-2.5 rounded-[2px] border border-[#1e293b] shadow">
            <Activity className="w-4 h-4 text-emerald-400 shrink-0" />
            <div>
              <div className="text-[10px] text-gray-400 font-black uppercase tracking-wider">SUNUCU TEPKİ</div>
              <div className="text-xs font-black text-white uppercase tracking-tight">14MS (OPTIMAL)</div>
            </div>
          </div>
          <div className="flex items-center gap-3 bg-[#050a14] px-3.5 py-2.5 rounded-[2px] border border-[#1e293b] shadow">
            <Zap className="w-4 h-4 text-purple-400 shrink-0" />
            <div>
              <div className="text-[10px] text-gray-400 font-black uppercase tracking-wider">TASARIM MODÜLÜ</div>
              <div className="text-xs font-black text-white uppercase tracking-tight">CANVA V2.0 AKTİF</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div>
        <div className="habbo-box-header mb-4 flex items-center justify-between">
          <span className="text-xs font-black uppercase tracking-wider text-white">SİSTEM İSTATİSTİKLERİ</span>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-4 gap-4">
          {stats.map((stat, i) => {
            ...
            return (
              <div 
                key={i} 
                className="habbo-box bg-[#050a14] hover:bg-[#0a1325] border border-[#1e293b] hover:border-[#facc15] rounded-[2px] p-5 transition-all relative overflow-hidden group shadow"
              >
                <div className="flex items-center justify-between mb-3 relative z-10">
                  <span className="text-[10px] font-black uppercase tracking-wider text-gray-400">{stat.label}</span>
                  <div className="p-2 rounded-[2px] bg-[#0a1325] border border-[#1e293b] text-[#facc15] group-hover:border-[#facc15] transition-colors">
                    <Icon size={18} />
                  </div>
                </div>
                <div className="text-2xl sm:text-3xl font-black text-white relative z-10 tracking-tight uppercase">
      ...
      <div className="habbo-box bg-[#0a1325] border border-[#1e293b] rounded-[3px] p-6 md:p-8 relative overflow-hidden shadow-2xl">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 relative z-10">
          <div className="max-w-2xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-[2px] bg-[#050a14] border border-[#facc15] text-[#facc15] text-[10px] font-black uppercase tracking-wider mb-3 shadow">
            ...
            <h3 className="text-lg md:text-xl font-black text-white uppercase tracking-wider">
              CANVA BENZERİ YAPAY ZEKA DERGİ & TASARIM MOTORU
            </h3>
            <p className="text-xs text-gray-300 mt-2 leading-relaxed font-bold uppercase tracking-wide">
          ...
          <Link 
            href="/admin/magazines" 
            className="habbo-button warning px-6 py-3.5 text-xs font-black uppercase tracking-wider flex items-center gap-3 shrink-0"
          >
            <Layers className="w-4 h-4" /> STÜDYOYU ŞİMDİ AÇ <ArrowRight className="w-4 h-4" />
          </Link>
        </div>
      </div>
      ...
      <div>
        <div className="habbo-box-header mb-4 flex items-center justify-between">
          <span className="text-xs font-black uppercase tracking-wider text-white">YÖNETİM MODÜLLERİ ({adminModules.length} SAYFA)</span>
          <span className="text-[10px] font-black text-[#facc15] uppercase tracking-wider">TÜM SAYFALARA ANINDA ERİŞİN</span>
        </div>
          ...
          {adminModules.map((mod, idx) => {
            ...
            return (
              <Link
                key={idx}
                href={mod.href}
                className="habbo-box bg-[#050a14] hover:bg-[#0a1325] border border-[#1e293b] hover:border-[#facc15] rounded-[2px] p-5 transition-all duration-200 flex flex-col justify-between group shadow"
              >
                <div>
                  <div className="flex items-center justify-between mb-3">
                    <div className="w-10 h-10 rounded-[2px] bg-[#0a1325] border border-[#1e293b] group-hover:border-[#facc15] flex items-center justify-center text-white group-hover:text-[#facc15] transition-colors">
                      <Icon size={18} />
                    </div>
                    {mod.badge && (
                      <span className="px-2 py-0.5 bg-[#facc15] text-black text-[9px] font-black uppercase rounded-[2px] tracking-wider shadow">
                        {mod.badge}
                      </span>
                    )}
                  </div>
                  <h3 className="font-black text-white text-sm uppercase tracking-wider group-hover:text-[#facc15] transition-colors flex items-center justify-between">
                    <span>{mod.title}</span>
                    <ArrowRight className="w-4 h-4 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all text-[#facc15]" />
                  </h3>
