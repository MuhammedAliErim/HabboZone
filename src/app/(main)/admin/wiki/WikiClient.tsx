    ...
    <div>
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
        <div>
          ...
          <p className="text-xs text-gray-300 font-bold uppercase tracking-wide mt-1">Wiki kütüphanesindeki tüm eşyaları yönetin.</p>
        </div>
        <div className="flex items-center gap-3">
          <Link 
            href="/admin/wiki/categories"
            className="habbo-button secondary px-4 py-2 text-xs font-black uppercase tracking-wider transition-all"
          >
            Kategorileri Yönet
          </Link>
          <button 
      ...
      <div className="bg-[#0a1325] border border-[#1e293b] rounded-[3px] p-4 mb-6 flex flex-col sm:flex-row gap-4">
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="w-full bg-[#050a14] border border-[#1e293b] rounded-[2px] pl-10 pr-4 py-2 text-white focus:outline-none focus:border-blue-500 transition-colors"
          />
        </div>
        <div className="sm:w-64 relative">
          ...
          <select
            ...
            className="w-full bg-[#050a14] border border-[#1e293b] rounded-[2px] pl-10 pr-4 py-2 text-white focus:outline-none focus:border-blue-500 transition-colors appearance-none"
          >
          ...
          <table className="w-full text-left text-sm text-gray-300">
            ...
            <tbody className="divide-y divide-[#1e293b]">
              {filteredItems.map((item) => (
                <tr key={item.id} className="hover:bg-[#0a1325]/50 transition-colors">
                  <td className="px-6 py-4">
                    <div className="w-12 h-12 bg-[#050a14] rounded-[2px] flex items-center justify-center p-1 relative border border-[#1e293b]">
                      <Image 
                        src={item.image_url} 
                        alt={item.name} 
                        fill
                  ...
                  <td className="px-6 py-4">
                    <span className="px-2.5 py-1 bg-[#050a14] border border-[#1e293b] rounded-[2px] text-xs font-medium">
                      {item.wiki_categories?.name || 'Bilinmiyor'}
                    </span>
                  </td>
                  <td className="px-6 py-4">
                    <span className={`px-2.5 py-1 rounded-[2px] text-xs font-medium ${
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-[#0a1325] border border-[#1e293b] rounded-[3px] shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto animate-in fade-in zoom-in duration-200">
            <div className="bg-[#050a14] border-b border-[#1e293b] px-6 py-4 flex items-center justify-between sticky top-0 z-10">
            ...
            <form onSubmit={handleSubmit} className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    />
                    {formData.image_url && (
                      <div className="mt-2 w-16 h-16 bg-[#050a14] border border-[#1e293b] rounded-[2px] p-1 relative flex items-center justify-center">
                        <Image 
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full bg-[#050a14] border border-[#1e293b] rounded-[2px] pl-10 pr-4 py-2.5 text-yellow-400 font-bold focus:outline-none focus:border-blue-500 transition-colors"
                        placeholder="Örn: 50"
                      />
                    </div>
                  </div>
              ...
              <div className="mt-8 flex items-center justify-end gap-3 pt-6 border-t border-[#1e293b]">
                <button
                  type="button"
                  onClick={closeModal}
