        ...
        <div className="bg-[#0f172a]">
            ...
            <div className="w-full h-[300px] md:h-[450px] border-b-2 border-black bg-[#0a1325] relative overflow-hidden">
                <Image 
                    ...
                    alt={newsItem.title}
                    fill
                    className={`object-cover pixelated transition-transform duration-700 group-hover/article:scale-105 ${isLocked ? 'opacity-30 grayscale' : 'opacity-90'}`}
                    unoptimized
                />
            ...
            {relatedNews.map((rn) => (
               <Link key={rn.id} href={`/news/${rn.slug}`} className="habbo-box bg-[#0f172a] overflow-hidden group/card flex flex-col hover:border-[#facc15] transition-colors">
                  <div className="h-32 w-full relative border-b-2 border-black overflow-hidden bg-[#0a1325]">
                     <Image src={rn.thumbnail_url || 'https://images.habbo.com/c_images/article_images_tr/tr_news_header_1.png'} fill className="object-cover pixelated group-hover/card:scale-110 transition-transform duration-500" alt={rn.title} unoptimized />
                   </div>
                  <div className="p-3">
